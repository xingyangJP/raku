...
export default function Create({ auth, categories, businessDivisions, defaultBusinessDivision }) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        business_division: defaultBusinessDivision || 'fifth_business',
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">新規商品作成</h2>}
        >
            <Head title="新規商品作成" />
